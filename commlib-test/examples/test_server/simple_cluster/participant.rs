...
use commlib::{ConnId, TcpClient, TcpConn};

pub struct Participant {
    name: String,
    discovery_cli: Arc<TcpClient>,
    public_addr: SocketAddr,
    known_participants: HashMap<String, Arc<TcpClient>>,
    greetings: HashMap<ConnId, (String, String)>,
}
            ...
            NetEvent::Connected(endpoint, established) => {
                if endpoint == self.discovery_endpoint {
                    if established {
                        ...
                        self.handler
                            .network()
                            .send(self.discovery_endpoint, &output_data);
                    } else {
